...
export type BuyPath = paths['/execute/buy/v7']['post']['responses']['200']['schema']['path'];
export type SellPath = paths['/execute/sell/v7']['post']['responses']['200']['schema']['path'];
export type Preview = paths['/execute/buy/v7']['post']['responses']['200']['schema']['preview'];
...
export type TransactionStepItem = Pick<NonNullable<Execute['steps'][0]['items']>[0], 'status' | 'orderIds' | 'orderIndexes' | 'orderData'> & {
    data: {
        data: any;
        from: `0x${string}`;
        to: `0x${string}`;
 ...
 */
export function pollUntilOk(request: AxiosRequestConfig, validate?: (res: AxiosResponse) => boolean, maximumAttempts?: number, attemptCount?: number): Promise<true | undefined>;
declare const zora: {
    readonly id: 7777777;
    readonly name: "Zora";
...
declare const zoraTestnet: {
    ...
    readonly blockExplorers: {
        readonly etherscan: {
            readonly name: "Zora Testnet explorer";
...
export const log: (params: any[], level: LogLevel, currentLevel: LogLevel) => void;
type ReservoirEventName = 'purchase_error' | 'purchase_complete' | 'accept_offer_error' | 'accept_offer_complete' | 'offer_error' | 'offer_complete' | 'listing_error' | 'listing_complete' | 'cancel_error' | 'cancel_complete' | 'unknown';
type ReservoirEvent = {
 ...
 */
export function executeSteps(request: AxiosRequestConfig, wallet: ReservoirWallet, setState: (steps: Execute['steps'], path: Execute['path']) => any, newJson?: Execute, expectedPrice?: number | Record<string, number>, chainId?: number, gas?: string): Promise<void>;
...
export type ReservoirEventListener = (event: ReservoirEvent, chainId: number) => void;
/**
...
export class ReservoirClient {
    ...
    normalizeRoyalties?: boolean;
    logLevel: LogLevel;
    log(message: Parameters<typeof log>['0'], level?: LogLevel): void;
    readonly utils: {
        ...
        adaptViemWallet: (wallet: {
            chain: import("viem").Chain<import("viem").Formatters> | undefined;
            key: string;
            name: string;
            pollingInterval: number;
            request: import("viem").EIP1193RequestFn<import("viem").WalletRpcSchema>;
            transport: import("viem").TransportConfig<string, import("viem").EIP1193RequestFn<undefined>> & Record<string, any>;
            type: string;
            uid: string;
            addChain: (args: import("viem").AddChainParameters) => Promise<void>;
            deployContract: <TAbi extends import("abitype").Abi | readonly unknown[], TChainOverride extends import("viem").Chain<import("viem").Formatters> | undefined>(args: import("viem").DeployContractParameters<TAbi, import("viem").Chain<import("viem").Formatters> | undefined, import("viem").Account<`0x${string}`> | undefined, TChainOverride>) => Promise<`0x${string}`>;
            ...
            sendTransaction: <TChainOverride_1 extends import("viem").Chain<import("viem").Formatters> | undefined>(args: import("viem").SendTransactionParameters<import("viem").Chain<import("viem").Formatters> | undefined, import("viem").Account<`0x${string}`> | undefined, TChainOverride_1>) => Promise<`0x${string}`>;
            signMessage: (args: import("viem").SignMessageParameters<import("viem").Account<`0x${string}`> | undefined>) => Promise<`0x${string}`>;
            signTypedData: <TTypedData extends {
                ...
                [key: string]: unknown;
            }, TPrimaryType extends string>(args: import("viem").SignTypedDataParameters<TTypedData, TPrimaryType, import("viem").Account<`0x${string}`> | undefined>) => Promise<`0x${string}`>;
            switchChain: (args: import("viem").SwitchChainParameters) => Promise<void>;
            watchAsset: (args: import("viem").WatchAssetParams) => Promise<boolean>;
            writeContract: <TAbi_1 extends import("abitype").Abi | readonly unknown[], TFunctionName extends string, TChainOverride_2 extends import("viem").Chain<import("viem").Formatters> | undefined>(args: import("viem").WriteContractParameters<TAbi_1, TFunctionName, import("viem").Chain<import("viem").Formatters> | undefined, import("viem").Account<`0x${string}`> | undefined, TChainOverride_2>) => Promise<`0x${string}`>;
            account: import("viem").Account<`0x${string}`> | undefined;
        }) => import("~/src").ReservoirWallet;
        customChains: {
            readonly zora: {
                readonly id: 7777777;
                readonly name: "Zora";
    ...
    readonly actions: ReservoirClientActions;
    constructor(options: ReservoirClientOptions);
    configure(options: ReservoirClientOptions): void;
    currentChain(): ReservoirChain | null;
    /**
     * Add an Event Listener
     * @param listener A function to callback whenever an event is emitted
     */
    addEventListener(listener: ReservoirEventListener): void;
    /**
     * Remove an Event Listener
     * @param listener The listener function to remove
     */
    removeEventListener(listener: ReservoirEventListener): void;
    /**
     ...
     * @param listener A function to callback whenever an event is emitted
     */
    _sendEvent(event: ReservoirEvent, chainId: number): void;
}
export function getClient(): ReservoirClient;
